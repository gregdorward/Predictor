...
const TeamOfTheWeek = () => {
  return (
    <div>
      <iframe
        id="sofa-totw-embed-17-52186-13221"
        width="100%"
        height="523"
        style={{ display: 'block', maxWidth: '700px' }}
        src="https://widgets.sofascore.com/embed/unique-tournament/17/season/52186/round/13221/teamOfTheWeek?widgetBackground=Gray&showCompetitionLogo=true&widgetTitle=Premier%20League&v=2"
        frameBorder="0"
        scrolling="no"
