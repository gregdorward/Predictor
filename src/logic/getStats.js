...
/** Domestic attack normalisation bands (midpoints preserved; ±20% wider than prior).
 *  Shots On Target widened further (overall ~0.6–8.5) so recency-weighted ~7 SOT does not floor. */
const DOMESTIC_ATTACK_RANGES = {
  overall: {
    ...
    "Weighted XG": { min: 0.8, max: 2.15 },
    "Average Goals": { min: 0.85, max: 2.01 },
    "Expected Points": { min: 0.44, max: 2.36 },
  ...
  last5: {
    ...
    "Expected Points": { min: 0.2, max: 2.6 },
...
/** Domestic defence normalisation bands (midpoints preserved; ±20% wider than prior).
 *  SOT Against / xGA widened further so recency-weighted early-season extremes do not floor. */
const DOMESTIC_DEFENCE_RANGES = {
  overall: {
    "Average XG Against": { min: 0.8, max: 2.15 },
    "Weighted XG Against": { min: 0.8, max: 2.15 },
  ...
  last5: {
    ...
    "Weighted XG Against": { min: 0.5, max: 2.4 },
