  ...
  if (calculate) {
    ...
    finalHomeGoals = await roundCustom(
      parseFloat(
        ...
        (XGAdjustedHomeGoals * 5 + formHome.goalsBasedOnAverages * 5) / 10
      )
    );
    ...
    finalAwayGoals = await roundCustom(
      parseFloat(
        ...
        (XGAdjustedAwayGoals * 5 + formAway.goalsBasedOnAverages * 5) / 10
      )
    );
