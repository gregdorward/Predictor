...
Environment:
  ...
  SCORE_MODEL_FAMILY           poisson|poisson_indep|negbin|bivariate|zip (default: poisson_indep)
  SCORE_NB_R                   Negative binomial dispersion (default: 12)
  SCORE_BIVARIATE_LAMBDA3      Bivariate shared intensity (default: 0.08)
  SCORE_ZIP_PI                 Zero-inflation π (default: 0.06)
  DIXON_COLES_RHO              Dixon–Coles ρ for poisson family (default: 0.075)
  SCORE_MATRIX_MAX_GOALS       Score grid cap (default: 5)
  SCORE_MATRIX_ALPHA           Temperature after normalise (default: 0.65)
