...
await esbuild.build({
  entryPoints: [resolve(__dirname, process.env.DIAGNOSE_ENTRY || "diagnose-match.mjs")],
  outfile: resolve(__dirname, process.env.DIAGNOSE_OUT || ".diagnose-bundle.mjs"),
  bundle: true,
  platform: "node",
  format: "esm",
  target: "node20",
